/*
	3 türlü sabit vardır (değeri değiştirilemeyen)
		1. #define
		2. const
		3. litterals (sabitler)
	* const vs #define
		* const 	: değişken olarak sabit
		* #define 	: ön işlemci sabiti 

	const örneği, değişken tanımlanır gibi tanımlanır
		* const int  LENGTH = 10;
		* const int  WIDTH  = 5;
		* const char NEWLINE = '\n';
	#define örneği, en başta tanımlanır
		* #define LENGTH 10   
		* #define WIDTH  5
		* #define NEWLINE '\n'
...
int topla(const int x, int y){
  ...
  a=x+y;
  return a;
  // parametrelerde const kullanılması, fonksiyonun içerisinde değişkenin değiştirilmesini engeller
}
