...
int main() {
   ...
   // Aritmetik operatörler, matematiksel işlemlerde kullanılır
   int a1 = 21, b1 = 10;
   cout << a1+b1 << endl ;
   // + - * / % ++ --
...
/*
  ...
  // bu operatörlerin sonucu true(1) ya da false(0) olur
  int a=20,b=10;
  if(a==b){
    cout<<"Şart sağlandı";
  }
...
/*
  // Mantıksal (Logic) Operatörler, sonucu mantıksal dır
  // bu operatörlerin sonucu true(1) ya da false(0) olur
  // karşılaştırma operatörleri ile birlikte kullanılır, birden fazla şartı birleştirmek için kullanılır
  // &&, ||, !
  int a=1; // bool a=true;
...
/*
  // Bitwise Operator (And Or, xor), sayıların ikili gösteriminde kullanılır
  // &, |, ^, ~, <<, >>
...
//-----------------------------------------------------------------------------------------
  ...
  // Atama operatörleri (2 operand olan işlemlerde), sağdaki değeri soldaki değişkene atar
  //  =     +=    -=    *=    *=    %=
  //        <<=   >>=   &=    |=    ^=   
...
//-----------------------------------------------------------------------------------------
/*
  // Koşul operatörü var=<şart>?doğruysa:değilse, "ternary operator" olarak da bilinir
  if(y < 10) { 
   var = 30;
  } 
  else {
  ...
  var=(y<10)?30:40;
  // iç içe ternary operatörü kullanımı da mümkündür
  // örneğin: var = (y < 10) ? 30 : (x > 10) ? 40 : 50;
*/  
//-----------------------------------------------------------------------------------------
/*
  // Virgül ","
  // bir dizi eş ifadeyi birbirinden ayırır, 
...
/*
  ...
  (&) operatörü c++ diline özgü referans oluşturmak için de kullanılır.
...
/*
  OPERATÖR ÖNCELİKLERİ
    ...
    (parantezler)     () [] -> .        	                Soldan Sağa, Önce Sol 
